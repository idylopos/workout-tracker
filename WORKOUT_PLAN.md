<!-- AUTO-GENERATED from lib.js (WEEK_PLAN). Run npm run sync-plan after changing the built-in plan. -->
...
2. **Box squat** — 3 × 5–8 · rest 3 min
   ...
   - **Watch:** Do not drop onto the box or let the knees collapse inward. Shorten the range if symptoms increase.

3. **Bulgarian split squat** — 2 × 8–10 / leg · rest 2 min
   - Log as: Weight × reps.
   - **Setup:** Place the rear foot on a low bench and keep enough distance for the front heel to stay down.
   - **Do:** Lower mostly through the front leg, then push through the whole front foot to rise.
   - **Watch:** Use support for balance. Keep the front knee tracking with the toes and use a comfortable depth.

4. **Assisted Nordic hamstring** — 1–2 × 3–5 · rest 2 min
   - Log as: Reps only.
...
6. **Standing calf raise** — 2 × 8–15 · rest 1 min
   ...
   - **Watch:** Keep the ankle tracking straight; do not bounce or roll onto the outer edge of the foot.

7. **Tibialis raise** — 2 × 12–20 · rest 1 min
   - Log as: Weight × reps.
   - **Setup:** Lean against a wall with heels on the floor and feet slightly forward.
...
#### Exercises and activities
1. **Half-kneeling 1-arm landmine press** — 3 × 6–8 / side · keep 2 RIR · use a comfortable path · rest 2 min
   - Log as: Weight × reps.
   - **Setup:** Kneel with the leg opposite the pressing arm forward. Hold the bar end near the shoulder and brace gently.
...
2. **Chest-supported neutral-grip row** — 3 × 6–10 · rest 2 min
   - Log as: Weight × reps.
   - **Setup:** Set the bench so the chest stays supported and use a neutral grip.
...
1. **Kettlebell swing** — 2–3 × 8–12 · rest 2 min
   ...
   - **Watch:** It is a hip hinge, not a squat or arm raise. Stop if the back rounds or the bell pulls the shoulders.

2. **Trap-bar deadlift** — 3 × 4–6 · rest 3 min
   - Log as: Weight × reps.
   - **Setup:** Stand centered in the bar, brace, and take the handles with the whole foot planted.
...
6. **Seated calf raise** — 2 × 10–15 · rest 1 min
   ...
   - **Watch:** Avoid bouncing or letting the feet roll inward or outward.
...
1. **Neutral-grip incline dumbbell press** — 3 × 8–12 · rest 3 min
   ...
   - **Watch:** Use the lowest comfortable incline and stop the descent before pinching or clicking becomes uncomfortable.

2. **One-arm landmine press** — 2 × 10–12 / side · rest 2 min
   - Log as: Weight × reps.
   - **Setup:** Stand in a split stance with the bar near the working shoulder and ribs stacked over the pelvis.
